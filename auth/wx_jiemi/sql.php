<?php
  ...
  {
    $sql = "INSERT INTO `serversql`.`user_info_tb` (`u_name`, `u_img`, `u_gender`, `u_language`, `u_city`, `u_province`, `u_country`) VALUES ($nickName,$avatarUrl, $gender,$language, $city,$province,
     $country )";
    $result =$conn->query($sql);
